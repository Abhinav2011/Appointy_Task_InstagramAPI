...
//regular expression for string matching from URL path
var (
...
func ConnectDB() (*mongo.Collection, *mongo.Collection) {
	...
	//collection_1 is to store users data
	//collection_2 is to store posts data
	collection_1 := client.Database("abhinav").Collection("users")
	collection_2 := client.Database("abhinav").Collection("posts")
